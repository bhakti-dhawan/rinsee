...
const AllUsers = () => {
  ...
  // Filter stores where title is not null or empty
  const filteredStores = employees.filter(
              ...
              <div className="col-span-3 flex items-center">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full overflow-hidden">
                    <img
                      src={store.profilePic || randomImage}
                      alt="Store"
